...
void makeModels() {
//// M1 : Cube
// Same as A18 but with UV vectors
...
// 1 bottom cap center, 1 top cap center, 4 overlapping vertices with differnt UV coordinates (so +2)
...
M2_vertices[baseIndex].pos = glm::vec3(cx + radius, cy + height, cz);
