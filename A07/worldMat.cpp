...
glm::mat4 MakeWorldMatrixEuler(glm::vec3 pos, glm::vec3 YPR, glm::vec3 size) {
	...
	// like the one available in a driving simulation or in a FPS
...
glm::mat4 MakeWorldMatrixQuat(glm::vec3 pos, glm::quat rQ, glm::vec3 size) {
	// A rotation defined by the Euler Angles doesn't have the "Gimbal Lock" problem
	// it's the proper solution for applications such as flight or space simulators
